...
void Cube::draw(QGraphicsScene* scene) {
   ...
   for (int i = 0; i < centerZ.size(); ++i) {
       ...
       case 0:
           front.draw(scene, QPen(Qt::red));
           break;
       case 1:
           back.draw(scene, QPen(Qt::darkRed));
           break;
       case 2:
           top.draw(scene, QPen(Qt::blue));
           break;
       case 3:
           bottom.draw(scene, QPen(Qt::darkBlue));
           break;
       case 4:
           left.draw(scene, QPen(Qt::green));
           break;
       case 5:
           right.draw(scene, QPen(Qt::darkGreen));
           break;
